...
<span style="color:#660033;"> Este documento es la versión en línea del bookdown **Manual para la Identificación de los hotspots del dengue en áreas urbanas de México**, es un libro diseñado para desarrollar las competencias específicas para la identificación de los hotspots del dengue en áreas urbanas y metropolitanas de México.</span>
